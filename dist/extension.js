...
const yaml_1 = __webpack_require__(5);
const openapi_1 = __webpack_require__(79);
function registerCommands(context) {
    ...
    const generate = vscode.commands.registerCommand('extension.generateRequests', async () => {
        ...
        vscode.window.showInformationMessage(`生成完成：${results.join(' | ')}`);
    });
...
function normalizeSwaggerConfigList(swagger) {
    if (!swagger) {
        return [];
    }
...
async function runGenerateOnce(workspaceRoot, config) {
    if (!config.jsonUrl || !config.outputDir) {
        throw new Error('jsonUrl 或 outputDir 为空');
    }
    return (0, openapi_1.generateFromOpenApi)({
        url: config.jsonUrl,
        workspaceRoot,
...
var composer = __webpack_require__(6);
var Document = __webpack_require__(11);
var Schema = __webpack_require__(29);
var errors = __webpack_require__(55);
var Alias = __webpack_require__(12);
var identity = __webpack_require__(9);
var Pair = __webpack_require__(20);
var Scalar = __webpack_require__(19);
var YAMLMap = __webpack_require__(31);
var YAMLSeq = __webpack_require__(34);
var cst = __webpack_require__(71);
var lexer = __webpack_require__(75);
var lineCounter = __webpack_require__(76);
var parser = __webpack_require__(77);
var publicApi = __webpack_require__(78);
var visit = __webpack_require__(10);
...
var node_process = __webpack_require__(7);
var directives = __webpack_require__(8);
var Document = __webpack_require__(11);
var errors = __webpack_require__(55);
var identity = __webpack_require__(9);
var composeDoc = __webpack_require__(56);
var resolveEnd = __webpack_require__(66);
...
var identity = __webpack_require__(9);
var Pair = __webpack_require__(20);
var toJS = __webpack_require__(16);
var Schema = __webpack_require__(29);
var stringifyDocument = __webpack_require__(54);
var anchors = __webpack_require__(13);
var applyReviver = __webpack_require__(15);
var createNode = __webpack_require__(18);
var directives = __webpack_require__(8);
...
var createNode = __webpack_require__(18);
var stringifyPair = __webpack_require__(21);
var addPairToJSMap = __webpack_require__(26);
var identity = __webpack_require__(9);
...
var stringifyComment = __webpack_require__(23);
...
var identity = __webpack_require__(9);
var stringifyComment = __webpack_require__(23);
var stringifyString = __webpack_require__(24);
...
var Scalar = __webpack_require__(19);
var foldFlowLines = __webpack_require__(25);
...
var tags = __webpack_require__(36);
...
var stringifyCollection = __webpack_require__(32);
var addPairToJSMap = __webpack_require__(26);
var Collection = __webpack_require__(17);
var identity = __webpack_require__(9);
var Pair = __webpack_require__(20);
...
var map = __webpack_require__(30);
var _null = __webpack_require__(37);
var seq = __webpack_require__(33);
var string = __webpack_require__(35);
var bool = __webpack_require__(38);
var float = __webpack_require__(39);
var int = __webpack_require__(41);
var schema = __webpack_require__(42);
var schema$1 = __webpack_require__(43);
var binary = __webpack_require__(44);
var merge = __webpack_require__(28);
var omap = __webpack_require__(46);
var pairs = __webpack_require__(47);
var schema$2 = __webpack_require__(48);
var set = __webpack_require__(52);
var timestamp = __webpack_require__(53);
...
var Scalar = __webpack_require__(19);
var stringifyNumber = __webpack_require__(40);
...
var node_buffer = __webpack_require__(45);
var Scalar = __webpack_require__(19);
var stringifyString = __webpack_require__(24);
...
var string = __webpack_require__(35);
var binary = __webpack_require__(44);
var bool = __webpack_require__(49);
var float = __webpack_require__(50);
var int = __webpack_require__(51);
var merge = __webpack_require__(28);
var omap = __webpack_require__(46);
var pairs = __webpack_require__(47);
var set = __webpack_require__(52);
...
var Document = __webpack_require__(11);
var composeNode = __webpack_require__(57);
var resolveEnd = __webpack_require__(66);
var resolveProps = __webpack_require__(60);
...
var Alias = __webpack_require__(12);
var identity = __webpack_require__(9);
var composeCollection = __webpack_require__(58);
var composeScalar = __webpack_require__(67);
var resolveEnd = __webpack_require__(66);
var utilEmptyScalarPosition = __webpack_require__(70);
...
var YAMLMap = __webpack_require__(31);
var YAMLSeq = __webpack_require__(34);
var resolveBlockMap = __webpack_require__(59);
var resolveBlockSeq = __webpack_require__(64);
var resolveFlowCollection = __webpack_require__(65);
...
var YAMLMap = __webpack_require__(31);
var resolveProps = __webpack_require__(60);
var utilContainsNewline = __webpack_require__(61);
var utilFlowIndentCheck = __webpack_require__(62);
var utilMapIncludes = __webpack_require__(63);
...
var identity = __webpack_require__(9);
var Scalar = __webpack_require__(19);
var resolveBlockScalar = __webpack_require__(68);
var resolveFlowScalar = __webpack_require__(69);
...
var cstScalar = __webpack_require__(72);
var cstStringify = __webpack_require__(73);
var cstVisit = __webpack_require__(74);
...
const fs = __importStar(__webpack_require__(2));
const path = __importStar(__webpack_require__(3));
const http_1 = __webpack_require__(80);
const models_1 = __webpack_require__(83);
const operations_1 = __webpack_require__(87);
const requests_1 = __webpack_require__(88);
const utils_1 = __webpack_require__(85);
async function generateFromOpenApi(options) {
    const doc = await (0, http_1.fetchJson)(options.url);
    const operations = (0, operations_1.collectOperations)(doc, {
        pathHidden: options.pathHidden,
        urlPrefix: options.urlPrefix
    });
    const models = (0, models_1.collectModels)(doc, {
    ...
    if (models.length > 0) {
        await (0, models_1.writeModelsFiles)(models, outputRoot);
    }
    const tagExportPaths = [];
    for (const [tag, list] of tagMap.entries()) {
        const tagDirName = (0, utils_1.resolveTagDirName)(tag, options.folderMap);
        const tagDir = path.join(outputRoot, tagDirName);
        await fs.mkdir(tagDir, { recursive: true });
        const { requestTs, requestDts } = (0, requests_1.buildTagFiles)(list);
    ...
    for (const exportPath of tagExportPaths) {
        const alias = (0, utils_1.toCamelCase)(path.basename(path.dirname(exportPath)));
...
const http = __importStar(__webpack_require__(81));
const https = __importStar(__webpack_require__(82));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.collectModels = collectModels;
exports.writeModelsFiles = writeModelsFiles;
const fs = __importStar(__webpack_require__(2));
const path = __importStar(__webpack_require__(3));
const schema_1 = __webpack_require__(84);
const utils_1 = __webpack_require__(85);
function collectModels(doc, options = {}) {
    ...
    for (const [rawName, schema] of Object.entries(schemas)) {
        ...
        for (const [propName, propSchema] of Object.entries(props)) {
            const camelName = (0, utils_1.toCamelCase)(String(propName));
            const type = (0, schema_1.schemaToTs)(propSchema, true);
            properties.push({
                name: camelName,
        ...
        results.push({
            ...
            name: (0, utils_1.normalizeModelName)(String(rawName)),
            properties,
            folder
        });
    }
...
async function writeModelsFiles(models, outputRoot) {
    ...
    const modelPathMap = new Map();
    for (const model of models) {
        const folder = model.folder ? (0, utils_1.sanitizeDirName)(model.folder) : '';
    ...
    for (const model of models) {
        ...
        await fs.writeFile(path.join(modelsRoot, `${relPath}.ts`), ['/* eslint-disable */', ...importLines, '', classBody].join('\n'), 'utf8');
        await fs.writeFile(path.join(modelsRoot, `${relPath}.d.ts`), [...importLines, '', declareBody].join('\n'), 'utf8');
...
function buildModelImports(model, modelNameSet, modelPathMap, relPath) {
    ...
    for (const dep of deps) {
        ...
        const from = (0, utils_1.toPosixPath)(path.relative(path.dirname(relPath), depPath));
        const importPath = from.startsWith('.') ? from : `./${from}`;
        lines.push(`import { ${dep} } from '${importPath}';`);
    }
    return lines;
}
function collectModelDependencies(model, modelNameSet) {
    const deps = new Set();
...
function buildModelClass(model, modelNameSet) {
    const lines = [];
...
function buildModelDeclaration(model) {
    const lines = [];
...
function buildFromJsonValue(prop, modelNameSet) {
    if (modelNameSet.has(prop.type)) {
...
function buildToJsonValue(prop, modelNameSet) {
    if (modelNameSet.has(prop.type)) {
...
function resolveModelFolder(rawName, schemasPackageMap, customModelFolder) {
    const normalizedRaw = String(rawName);
    if (customModelFolder[normalizedRaw]) {
        return customModelFolder[normalizedRaw];
    }
    const nameOnly = (0, utils_1.normalizeModelName)(normalizedRaw);
...
const utils_1 = __webpack_require__(85);
function schemaToTs(schema, useRef = false) {
    if (!schema || typeof schema !== 'object') {
        return 'any';
    }
    if (schema.$ref) {
        ...
        return (0, utils_1.normalizeModelName)((0, utils_1.resolveRefName)(String(schema.$ref)));
    }
    switch (schema.type) {
        case 'string':
            return 'string';
...
exports.resolveTagDirName = resolveTagDirName;
exports.toPosixPath = toPosixPath;
const path = __importStar(__webpack_require__(3));
const pinyin_pro_1 = __webpack_require__(86);
...
function resolveTagDirName(tag, folderMap) {
    if (folderMap && folderMap[tag]) {
        return sanitizeDirName(folderMap[tag]);
    }
    if (hasCjk(tag)) {
        const romanized = (0, pinyin_pro_1.pinyin)(tag, { toneType: 'none', type: 'array' }).join('-');
...
exports.buildOperationModel = buildOperationModel;
exports.collectParameters = collectParameters;
exports.resolveBodyModel = resolveBodyModel;
exports.resolveResponseModel = resolveResponseModel;
exports.buildOperationName = buildOperationName;
const schema_1 = __webpack_require__(84);
const utils_1 = __webpack_require__(85);
function collectOperations(doc, options = {}) {
    const results = [];
...
function buildOperationModel(op, modelLookup) {
...
function collectParameters(parameters) {
    ...
    for (const param of parameters) {
        ...
        const type = (0, schema_1.schemaToTs)(param.schema);
        const info = {
            name: param.name,
            location,
...
function resolveBodyModel(requestBody, modelLookup) {
    ...
    for (const media of Object.values(content)) {
        ...
        if (schema.$ref) {
            const refName = (0, utils_1.resolveRefName)(String(schema.$ref));
            return modelLookup.get(refName);
        }
    }
    return undefined;
}
function resolveResponseModel(responses, modelLookup) {
...
function extractResponseModel(schema, modelLookup) {
    if (!schema || typeof schema !== 'object') {
        return undefined;
    }
...
function pickPreferredResponse(candidates) {
...
function isGenericResponse(name) {
...
function pickPreferredListModel(candidates) {
    if (candidates.length === 0) {
        return undefined;
    }
...
function findPageDataRef(schema) {
    if (!schema || typeof schema !== 'object') {
        return undefined;
    }
    if (schema.$ref) {
...
function findListItemModel(schema, modelLookup) {
    if (!schema || typeof schema !== 'object') {
        return undefined;
    }
    const candidates = [];
...
function buildOperationName(op) {
    if (op.operationId && /[A-Za-z0-9]/.test(op.operationId)) {
        return (0, utils_1.toCamelCase)(op.operationId);
    }
    if (op.summary && /[A-Za-z0-9]/.test(op.summary)) {
        return (0, utils_1.toCamelCase)(op.summary);
    }
    ...
    return (0, utils_1.toCamelCase)(base || `${op.method}Api`);
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.writeBaseHttpFiles = writeBaseHttpFiles;
exports.buildTagFiles = buildTagFiles;
const fs = __importStar(__webpack_require__(2));
const path = __importStar(__webpack_require__(3));
const utils_1 = __webpack_require__(85);
...
function buildTagFiles(operations) {
    ...
    typeLines.push(`import { applyPathParams, request${needsPageResp ? ', PageResp' : ''} } from '../base_http';\n\n`);
    if (needsModels) {
...
function buildFunctionSignature(op, pascal, pathInterface, queryInterface, bodyInterface) {
    const args = [];
    if (op.pathParams.length === 1) {
    ...
    const urlExpr = op.pathParams.length > 1
...
function normalizeReturnType(typeName, wrapper) {
...
function buildBodyType(op, bodyInterface) {
    if (!op.hasBody) {
        return undefined;
    }
    if (op.bodyModel) {
...
function buildDocComment(op, returnType, bodyType) {
...
function buildInterface(name, params) {
